      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <ScrollAnimation direction="up" delay={100}>
          <div className="w-full">
            <div className="relative w-full aspect-[21/9] rounded-2xl overflow-hidden shadow-2xl bg-[#ACB792]">
              {/* Placeholder - will be replaced with team image */}
              <div className="absolute inset-0 flex items-center justify-center">
                <p className="text-primary/30 text-lg font-medium">Photo de l'équipe à venir</p>
              </div>
              {/* Image will be added here when available */}
              {/* <Image
                src="/equipe.jpg"
                alt="L'équipe Coffee Arts Paris"
                fill
                className="object-cover"
              /> */}
            </div>
