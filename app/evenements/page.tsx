  ...
  const eventTypes = [
    {
      ...
      image: "/PAGE D'ACCUEIL - PHOTO 1.jpg",
    },
    {
      title: "Privatisation",
            ...
            {eventTypes.map((event, index) => {
              return (
                <ScrollAnimation key={event.title} direction="up" delay={index * 100}>
                  <div className="group relative bg-white/50 backdrop-blur-xl rounded-[2rem] p-10 shadow-xl border border-white/60 hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 overflow-hidden">
                    {/* Background Image */}
                    <div className="absolute inset-0 z-0">
                      <Image
                        ...
                        alt={event.title}
                        fill
                        className="object-cover opacity-30 group-hover:opacity-60 transition-all duration-700 group-hover:scale-105"
                      />
                    </div>
